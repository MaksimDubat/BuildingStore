...
namespace ProductService.Domain.Interfaces
{
    ...
    public interface ICartItemRepository : IBaseRepository<CartItem>
    {
        ...
        Task<CartItem> DeleteCartItemAsync(int cartId, int productId, CancellationToken cancellation);
        ...
        /// <param name="cancellation"></param>
        Task<CartItem> ChangeAmountAsync(int amount, int productId, int cartId, CancellationToken cancellation);
